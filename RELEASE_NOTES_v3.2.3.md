...
* **Expanded unit test coverage**, directly validating these security fixes, UX enhancements, and robustness improvements.

---

## 📜 Changelog:
* v3.2.3 - Fixed Windows command injection, resolved path traversal in utility manager, implemented HTTP timeouts, optimized SafetyManager by pre-compiling regexes, improved non-TTY fallback prompts, and expanded test suite with full coverage.
