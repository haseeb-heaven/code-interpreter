# open-agent: Quotas and pricing

open-agent offers a generous free tier that covers many individual developers'
...
This article outlines the specific quotas and pricing applicable to open-agent
...
Access to open-agent begins with a generous free tier, perfect for
...
open-agent by upgrading to one of the following subscriptions:
...
open-agent. Supporting these plans is under active consideration for future
support.
