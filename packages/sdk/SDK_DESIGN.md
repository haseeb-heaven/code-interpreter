...
```ts
import { GeminiCliAgent } from '@open-agent/sdk';
...
```ts
import { GeminiCliAgent, tool, z } from "@open-agent/sdk";
...
```ts
import { GeminiCliAgent, hook, z } from '@open-agent/sdk';
...
```ts
import { hook } from "@open-agent/sdk";
...
```ts
import { GeminiCliAgent, subagent } from "open-agent";
...
```ts
import { GeminiCliAgent, extension } from "@open-agent/sdk";
...
```ts
import { GeminiCliAgent } from "@open-agent/sdk";
import { GeminiCliAcpServer } from "@open-agent/sdk/acp";
