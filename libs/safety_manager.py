...
class ExecutionSafetyManager:
	...
	# ⚡ Bolt: Pre-compile regular expressions as a tuple of re.Pattern objects
	# to bypass the re module cache lookup and speed up repeated pattern matching
	# in safety-critical loops, avoiding re-allocation overhead.
